...
function DetailView() {
    ...
    return (
        <div className="movie-detail">
            ...
            <button className="add-to-cart" onClick={() => setCart((prevCart) => prevCart.set(params.id, {title: movie.original_title, poster: movie.poster_path}))}>{`${cart.has(params.id) ? 'Added' : 'Buy'}`}</button>
